...
function App() {
  ...
  return (
    <>
          ...
          <nav className="navbar">
            <div>
              <button onClick={() => setOpenFeatures(!openFeatures)} className="flex items-center justify-start">
                Features {openFeatures ? <img src={chevronUp} alt="" className="ml-2"/> : <img src={chevronDown} alt="" className="ml-2"/>}
              </button>
              {openFeatures && <ul className="mt-2 ml-3 lg:ml-0 lg:p-3 lg:shadow">
                ...
                <li className="flex items-center justify-start text-sm mb-2">
                  <img src={reminder} alt="" className="mr-2" /> Reminder
                </li>
                <li className="flex items-center justify-start text-sm mb-2">
      ...
      <section className="flex flex-col-reverse py-20 md:grid md:gap-10 md:grid-cols-2 md:place-items-center max-w-4xl lg:max-w-5xl md:mx-auto">
        <article className="text-center md:text-left px-5 xl:px-0 mt-10 md:mt-0">
          <h1 className="font-bold text-4xl xl:text-7xl lg:text-6xl mb-5">
            Make <br /> remote Work
          </h1>
          <p className="mb-5">
    ...
    Coded by <a href="#">JohnBosco I. Oparah</a>.
  </div>
    </>
  );
}
